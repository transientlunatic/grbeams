...
\subsection*{Jet Angle Posterior}
  ...
  \begin{minipage}{\columnwidth}
    ...
    \subfloat[Rate Posterior]{%
      \includegraphics[width=0.45\linewidth]{rate_posterior_s6UL.pdf}%
      \label{fig:}%
    }\qquad%
    \subfloat[Jet Posterior]{%
      \includegraphics[width=0.45\linewidth]{theta_posteriors_s6UL.pdf}%
      \label{fig:}%
    }
    \caption{S6 results}
  \end{minipage}
...
\begin{center}\vspace{1cm}
    %\includegraphics[width=15cm]{rate_re.pdf}
