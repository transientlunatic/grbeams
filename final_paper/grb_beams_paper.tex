...
\subsection{Beaming angle inferences}
In this section, we discuss our approach to estimating the short GRB beaming angle based
on the binary neutron star inspiral rate, estimated through the observed number of gravitational waves
from binary neutron star inspirals. The aim here is to develop an approach that 
folds in uncertainties in in the binary neutron star inspiral rate and our ignorance
about the rate at which binary neutron star inspirals lead to short gamma-ray bursts.
...
\subsection{Robustness of Mean Angle Inference To Distribution Width}
