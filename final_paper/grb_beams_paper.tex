...
$x$-axis correspond to different choices of the distribution width and the
separate curves correspond to different choices of the distribution mean.  We
stress here that such $\theta$ distributions are \emph{not} intended to
represent any physical reality; rather, they are merely intended to easily
demonstrate the qualitative effects of different $\theta$ distributions on the
ratio 

truncated Normal distribution of mean $\langle \theta
\rangle$, standard deviation $\sigma_{\theta}$, 
