...
%
\begin{equation}
    N_G = \frac{4}{3} \pi \left( \frac{\mathcal{D}}{\textrm{Mpc}}
\right)^3 (2.26)^{-3} (0.0116),
\end{equation}
%
where ${\mathcal D}$ is the distance at which an optimally-oriented
...
%
\begin{eqnarray}
    p(\cbcrate|n,T,b,{\mathcal D}) & = & p(s|n,T,b) \left|\frac{\diff s}{\diff \cbcrate}\right| \\
                                   & = & N_G(\mathcal{D})p(s|n,T,b)
\end{eqnarray}
%
