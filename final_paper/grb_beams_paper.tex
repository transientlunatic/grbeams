...
place an upper limit of $^{\circ}$ on the jet beaming angle, and can
establishing the limit on the beaming angle to be between
$8.45^{\circ}$ and $58.93^{\circ}$, assuming an uninformative prior on
the \acp{SGRB} production efficiency. These limits narrow between
$8.80^{\circ}$ and $16.20^{\circ}$ if perfect efficiency is assumed.
