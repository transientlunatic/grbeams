...
\newcommand{\BNSmm}{\ac{NS}-\ac{NS}} %math-mode friendly BNS
...
\begin{enumerate}
    ...
    \item Draw $N_{\mathrm{\BNSmm}}$ values of orbital inclination $\iota$ from a distribution which is uniform in $\cos \iota$ in the range $[0,1]$.
...
$N_{\mathrm{GRB}}/N_{\mathrm{\BNSmm}}$.  Since it is the comparison of
the rates of these events that informs our inference on $\theta$,
studying the ratio $N_{\mathrm{GRB}}/N_{\mathrm{\BNSmm}}$ provides some
...
distributions on the ratio $N_{\mathrm{GRB}}/N_{\mathrm{\BNSmm}}$.
...
For example, for the ${\mathcal N}(15,9)$ and ${\mathcal N}(10,13)$ beaming angle populations, the ratios of $N_{\mathrm{GRB}}/N_{\mathrm{\BNSmm}}$ are almost equal ($\sim 4.8\%$).
