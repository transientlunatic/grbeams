...
the rate of \bns{} coalescence in the local Universe.  For this study, we
consider two operation epochs, the 2016--17 and 2022+ scenarios described
in~\cite{ade_prospects}. For each epoch, we produce results for both the
`realistic' and `high' \bns{} rates described in~\cite{rates_paper}.
