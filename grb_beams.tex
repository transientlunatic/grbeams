...
\subsection{Early Epoch aLIGO Observing Scenarios}
In this section, we report results using the search volumes and numbers of
detections listed in~\ref{table:scenarios} for the 2016--17 epoch.  If the
expected number of detections $N_{\mathrm{det}}$ is non-integer, we round down.
...
\subsection{Late Epoch aLIGO Observing Scenearios}
