...
def parse_input():
    ...
    parser.add_argument('rate_posterior_file', metavar='pi', type=str, nargs=1, 
            help="type of prior to use for efficiency")
...
scenario = grbeams_utils.O1Scenario(args.rate_posterior_file[0])
...
f_angle_pickle = file('O1_angle_%s.pickle'%(prior_names[args.prior[0]]),'wb')
...
f_angle.savefig('O1_angle_%s.pdf'%(\
        prior_names[args.prior[0]]))
f_angle.savefig('O1_angle_%s.eps'%(\
        prior_names[args.prior[0]]))
f_angle.savefig('O1_angle_%s.png'%(\
        prior_names[args.prior[0]]))

f_rate.savefig('O1_rate.eps')
f_rate.savefig('O1_rate.pdf')
f_rate.savefig('O1_rate.png')
f_rate_pickle = file('O1_rate.pickle','wb')
